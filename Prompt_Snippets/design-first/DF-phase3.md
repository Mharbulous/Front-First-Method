...
graph TD
    ...
    subgraph Phase3 ["Phase 3: AI-Assisted Backend Development & Integration"]
        D_Loop_Start --> D1["3.1 AI-Assisted: Generate Boilerplate Code for Feature"]
        D1 --> D1_Val{"Human Review Boilerplate?"}
        D1_Val -->|Needs Revision| D1
        D1_Val -->|Approved| D2["3.2 AI-Assisted: Implement Core Business Logic for Feature"]
        D2 --> D2_Val{"Human Review Business Logic?"}
        D2_Val -->|Needs Revision| D2
        D2_Val -->|Approved| D3["3.3 AI-Assisted: Integrate Feature with Front-End"]
